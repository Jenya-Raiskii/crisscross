...
def reset_on():
	if count_check==True:
		if but1.cget('text') == but2.cget('text') and but2.cget('text') == but3.cget('text'):
			obnul()

		elif but1.cget('text') == but4.cget('text') and but4.cget('text') == but7.cget('text'):
			obnul()

		elif but4.cget('text') == but5.cget('text') and but5.cget('text') == but6.cget('text'):
			obnul()

		elif but7.cget('text') == but8.cget('text') and but8.cget('text') == but9.cget('text'):
			obnul()

		elif but3.cget('text') == but6.cget('text') and but6.cget('text') == but9.cget('text'):
			obnul()

		elif but2.cget('text') == but5.cget('text') and but5.cget('text') == but8.cget('text'):
			obnul()

		elif but1.cget('text') == but5.cget('text') and but5.cget('text') == but9.cget('text'):
			obnul()
		elif but1.cget('text') == but4.cget('text') and but4.cget('text') == but7.cget('text'):
			obnul()

		elif but3.cget('text') == but5.cget('text') and but5.cget('text') == but7.cget('text'):
			obnul()
...
Lab2=Label(root, width=10,text='Выиграл: ',font='ArialBlack 10')
